...
const ICONOS: Record<string, string> = {
  ...
  top: 'M19,5h-2V3H7v2H5C3.9,5 3,5.9 3,7v1c0,2.55 1.92,4.63 4.39,4.94 0.63,1.5 1.98,2.63 3.61,2.96V19H7v2h10v-2h-4v-3.1c1.63,-0.33 2.98,-1.46 3.61,-2.96C19.08,12.63 21,10.55 21,8V7C21,5.9 20.1,5 19,5zM5,8V7h2v3.82C5.84,10.4 5,9.3 5,8zM19,8c0,1.3 -0.84,2.4 -2,2.82V7h2V8z',
  corredora: 'M12,17.27L18.18,21l-1.64,-7.03L22,9.24l-7.19,-0.61L12,2 9.19,8.63 2,9.24l5.46,4.73L5.82,21z',
  elenco:
    'M3,7h8V5H3V7zM3,12h8v-2H3V12zM3,17h8v-2H3V17zM12.6,10.4l2.4,2.4l5.6,-5.6l1.4,1.4l-5.6,5.6l-2.4,-2.4z',
  ajustes:
  ...
  ranking: 'M5,10h4v7h-4zM11,6h4v11h-4zM17,13h4v4h-4z',
  ...
  info: 'M11,18H13V16H11V18M12,6A2,2 0 0,0 10,8A2,2 0 0,0 12,10A2,2 0 0,0 14,8A2,2 0 0,0 12,6M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,16.41 16.41,20 12,20Z',
}
...
let { nombre, titulo, class: clase = '' }: Props = $props()
</script>

<svg viewBox="0 0 24 24" aria-hidden={titulo ? undefined : true} role={titulo ? 'img' : undefined} class={clase}>
  {#if titulo}<title>{titulo}</title>{/if}
